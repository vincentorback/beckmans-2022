...
export const randomPerson = (index) => {
  ...
  return {
    ...
    image: `https://source.unsplash.com/random/500x500/?${name}`,
    title: {
      sv: 'Namn på arbete',
      en: 'Title of work',
    },
    ...
    images: [
      `https://source.unsplash.com/random/500x500?${name}`,
      `https://source.unsplash.com/random/500x500?${name + 1}`,
      `https://source.unsplash.com/random/500x500?${name + 2}`,
      `https://source.unsplash.com/random/500x500?${name + 3}`,
    ],
  }
}
